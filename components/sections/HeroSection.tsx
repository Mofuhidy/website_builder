...
export function HeroSection({ data }: HeroSectionProps) {
  const title = (data.title as string) || "عنوان رئيسي جذاب";
  const subtitle = (data.subtitle as string) || "هذا هو الوصف الفرعي الذي يوضح القيمة المقدمة من موقعك بشكل مختصر وجميل.";
