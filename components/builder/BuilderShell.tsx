  ...
  return (
    <div className="flex h-screen w-full flex-col bg-background overflow-hidden text-foreground">
      ...
      <main className="flex flex-col-reverse md:flex-row flex-1 overflow-hidden relative">
        <aside
          style={{ "--builder-sidebar-width": `${sidebarWidth}px` } as React.CSSProperties}
          className="w-full md:w-[var(--builder-sidebar-width)] h-[50vh] md:h-auto bg-white border-t md:border-t-0 md:border-l border-border-color flex flex-col-reverse md:flex-row shrink-0 relative">
          {/* Resize Handle */}
          <div
